...
while (post is not None):
    ...
    for followup in followups:
        ...
        for comment in comments:
            ...
            nodes.add(commentor)
            node_sizes[commentor] = node_sizes.get(commentor, 1) + 0.1
...
nx.write_gexf(G, 'cs6460_test.gexf')
...
# print('Betweenness centrality: ' + str(nx.centrality.betweenness_centrality(G)))
# closeness (how many other students have a short path to that node)
# print('Closeness centrality: ' + str(nx.centrality.closeness_centrality(G))) 
#  degree (number of connections they have)
# print('Degree centrality: ' + str(nx.centrality.degree_centrality(G))) 
